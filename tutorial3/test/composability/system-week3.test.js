...
const { deployContract, airdropSOL, airdropNEON } = require("./utils.js");
...
describe('\u{1F680} \x1b[36mSystem program composability tests\x1b[33m',  async function() {
    ...
    before(async function() {
        ...
        await airdropNEON(deployer.address, ethers.parseUnits('2000', 9))
    ...
    describe('\n\u{231B} \x1b[33m Testing on-chain formatting and execution of Solana\'s System program \x1b[36mcreateAccountWithSeed\x1b[33m instruction\x1b[0m', function() {
        ...
        it('Create account with seed', async function() {
            ...
            createWithSeedAccountInBytes = await callSystemProgram.getCreateWithSeedAccount(
                ...
                Buffer.from(seed), {
                  maxPriorityFeePerGas: ethers.parseUnits('1', 18),
                  maxFeePerGas: ethers.parseUnits('30', 18)
                }
            )
            console.log("CreateWithSeedAccountInBytes: " + ethers.encodeBase58(createWithSeedAccountInBytes))
            ...
            console.log("createWithSeedAccountInBytes", new web3.PublicKey(ethers.encodeBase58(createWithSeedAccountInBytes)))
...
/* NOTE: For this test to succeed, I needed to manually send SOL to the account amounting to rentExemptBalance
    describe('\n\u{231B} \x1b[33m Testing on-chain formatting and execution of Solana\'s System program \x1b[36massignWithSeed\x1b[33m instruction\x1b[0m', function() {
            ...
            it('Assign an account to the Token program', async function() {
                ...
                console.log("CreateWithSeedAccountInBytes: " + ethers.encodeBase58(createWithSeedAccountInBytes))
                console.log("rentExemptBalance: " + rentExemptBalance.toString())
