...
describe('Test init', async function () {
    before(async function() {
        ...
        //const owner = new ethers.Wallet(process.env.PRIVATE_KEY_OWNER, ethers.provider);
        ...
        console.log("MemeLaunchpadAddress", MemeLaunchpadAddress);
        if (ethers.isAddress(MemeLaunchpadAddress)) {
            ...
            console.log("deploying MemeLaunchpad");

            try {
                //await ethers.provider.send('evm_increaseTime', [1000000000]);
                console.log("ERC20ForSplFactory", config.DATA.EVM.ADDRESSES.ERC20ForSplFactory);
                console.log("BondingCurve.target", BondingCurve.target);
                console.log("WSOL.target", WSOL.target);
        ...
        console.log("MemeLaunchpad", MemeLaunchpad);
